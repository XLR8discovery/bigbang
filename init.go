...
import (
	...
	"xlr8d.io/bigbang/pkg/runtime/standalone"
)
...
func initCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Initialize new bigbang stack with the chosen container orchestrator. " + SelectorHelp + ". Without argument it generates " +
